...
public class TrainConfigManager {
     ...
     *
     */
    public FlashCardModule buildCardGuiManager(Card card) {
        FlashCardModule flashCardModule = null;
        this.card = card;
        ...
        if (!trainConfig.getVerbConfig().getDefaultMode() && verbIds.contains(card.getId())) {
            ...
            flashCardModule = new FlashCardModule(mainController, conjugatedVerbCard);
        } else {
            flashCardModule = new FlashCardModule(mainController);
        }
